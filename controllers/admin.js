...
var Dealer, EventProxy, Iconv, Lots, User, config, crypto, csv, defaultDealer, exportCSV, fs, getList, getType, getlots, gettf, helper, nodeExcel, path, resetCode, str, unique;
...
exports.downloadxml = function(req, res, next) {
  ...
  return Lots.count(function(err, count) {
    return exportCSV(st, et, count, function(err, list) {
