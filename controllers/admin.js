...
var Dealer, EventProxy, Lots, User, config, crypto, csv, defaultDealer, exportCSV, fs, getChanged, getCtrl, getDates, getList, getReser, getType, getlots, gettf, helper, nodeExcel, path, resetCode, str, unique;
